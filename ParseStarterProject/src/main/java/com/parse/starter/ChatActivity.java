...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayAdapter = new ArrayAdapter(this , android.R.layout.simple_dropdown_item_1line , messages);
        chatListView.setAdapter(arrayAdapter);


        ParseQuery<ParseObject> query1 = new ParseQuery<ParseObject>("Message");
        query1.whereEqualTo("sender" , ParseUser.getCurrentUser().toString());
        query1.whereEqualTo("reciever" , activeUser);

        ParseQuery<ParseObject> query2 = new ParseQuery<ParseObject>("Message");
        query2.whereEqualTo("sender" , activeUser);
        query2.whereEqualTo("reciever" , ParseUser.getCurrentUser().toString());
    ...
    public void sendChat(View view){
        ...
        message.put("sender", ParseUser.getCurrentUser().toString());
